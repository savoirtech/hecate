...
public class JavaOffsetDateTimeConverterTest extends Assert {
//----------------------------------------------------------------------------------------------------------------------
// Other Methods
//----------------------------------------------------------------------------------------------------------------------
    ...
    public void testToColumnValue() {
        ...
        JavaOffsetDateTimeConverter converter = new JavaOffsetDateTimeConverter();
    ...
    public void testGetValueType() {
        assertEquals(OffsetDateTime.class, new JavaOffsetDateTimeConverter().getValueType());
    }

    @Test
    public void testGetDataType() {
        assertEquals(DataType.varchar(), new JavaOffsetDateTimeConverter().getDataType());
    }

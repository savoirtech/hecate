...
package com.savoirtech.hecate.pojo.query.parameter;
...
public class ParameterBindingConverter implements ParameterConverter {
//----------------------------------------------------------------------------------------------------------------------
// Fields
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public ParameterBindingConverter(ParameterBinding binding) {
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public Object convertParameter(Iterator<Object> parameters) {
        return binding.toColumnValue(parameters.next());
    }
}

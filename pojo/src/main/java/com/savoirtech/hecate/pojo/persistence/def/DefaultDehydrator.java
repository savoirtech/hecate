...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public DefaultDehydrator(PersistenceContext persistenceContext, int ttl, StatementOptions options, UpdateGroup updateGroup) {
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    public void execute() {
        while (!agenda.isEmpty()) {
            ...
            pojos.forEach(pojo -> insert.insert(updateGroup, pojo, this, ttl, options));
        }
    }
}
